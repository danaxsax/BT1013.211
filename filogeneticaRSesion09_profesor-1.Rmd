...
```{r}
ggtree(virus_plot)
ggtree(virus_plot, layout="slanted") 
ggtree(virus_plot, layout="circular")
ggtree(virus_plot, layout="fan", open.angle=120)
ggtree(virus_plot, layout="equal_angle")
ggtree(virus_plot, branch.length='none')
ggtree(virus_plot, branch.length='none', layout='circular')
