...
file_names <- c("B-1-640-1.fasta", "BA-2-75-2.fasta", "BA-2-86.fasta", "EG-5-1.fasta", "JN-1.fasta",
                "XBB-1-9-1.fasta", "XBB-1-16.fasta", "XBB-2-3.fasta", "ZETA.fasta", "ALFA.fasta")
...
for (i in 1:nrow(data)) {
  ...
  p <- ggplot(data = data[i, ], aes(x = Tamanio, y = GC)) +
    geom_point() +
    labs(title = seq, x = "Tamaño", y = "Contenido de GC (%)") +
    theme_minimal()
  print(p)
}
```
