...
En específico, estas secuencias tienen un bajo contenido de citosina y guanina, por lo que las hebras pueden separarse más fácilmente, lo que facilita la replicación del virus porque no requieren de tanta energía para la separacion de hebras.

La visualización de estos datos, ayuda al entendimiento de la similitud entre variantes y permite un mayor entendimiento de estas.
...
Mismo caso en cuanto a Vietnam y Corea del Sur; sin embargo, en este caso no están tan juntos, se encuentran en una misma rama y sus secuencias presentan similitudes.
